        ...
        if v:IsA("Model") and v ~= LocalPlayer.Character then
            ...
            if head and hrp then
                if espToggle then
                    ...
                    local hrpPos, onScreenHrp = Camera:WorldToScreenPoint(hrp.Position)
                    if onScreenHead and onScreenHrp then
                        ...
                        box.Position = Vector2.new(headPos.X - boxSize/2, headPos.Y - boxSize/2)
                        box.Visible = true
                    else
                        box.Visible = false
                    end
