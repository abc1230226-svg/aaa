...
local CoreGui = game:GetService("CoreGui") -- 改為在CoreGui建立UI
...
ScreenGui.Parent = CoreGui -- 改為在CoreGui建立
...
ListTitle.Position = UDim2.new(0, 10, 0, 215)
...
PlayerList.Position = UDim2.new(0, 10, 0, 245)
